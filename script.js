document.addEventListener('keydown', (event) => {
    ...
    if (keyCode == 83) {
        ...
        audio.currentTime = 0;
        audio.play();
        document.getElementById('83').style.backgroundColor = "#ff00ff"
        document.getElementById('83').style.boxShadow = "0px 0px 20px 0px #ff00ff";
        setTimeout(function(){
    ...
    if (keyCode == 68) {
        ...
        audio.currentTime = 0;
        audio.play();
        document.getElementById('68').style.backgroundColor = "#ff00ff"
        document.getElementById('68').style.boxShadow = "0px 0px 20px 0px #ff00ff";
        setTimeout(function(){
